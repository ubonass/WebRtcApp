package org.ubonass.database;

import android.database.Cursor;
import org.ubonass.utils.CoreDBManager;


import java.util.ArrayList;
import java.util.List;

public class CoreDataBase /*implements IEventListener*/ {
    public static String APP_DB_PATH = "/data/data/org.ubonass/";
    private final String TEXTTAG = "CoreDataBase";
    ...
    public CoreDataBase(){
        ...
        coreDBM.initCoreDB(APP_DB_PATH +"databases/", "userid");
        //历史表
