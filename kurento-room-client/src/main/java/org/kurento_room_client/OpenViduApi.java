 ...
 * //1) new KurentoRoomApi()
 * //2) addTrustedCertificate()，，use getCertificateByAssets
 * //3) useSelfSignedCertificate(true)
 * //4) connectWebSocket()
 */
public class KurentoRoomApi extends KurentoApi {
     ...
     */
    public KurentoRoomApi(LooperExecutor executor,
                          String uri, RoomListener listener) {
        super(executor, uri);
        ...
        try {
            ...
            //2)
            keyStore.load(null, null);////双向验证时不为null
    ...
    public void sendJoinRoom(String userId,
                             String roomId,
                             boolean dataChannelsEnabled,
                             int id) {
    ...
    public void sendJoinRoom(String session,
                             String token,
                             String metadata,
                             String secret,
                             String platform,
                             String recorder,
                             int id) {
        HashMap<String, Object> joinRoomParams = new HashMap<>();
        ...
        send("joinRoom", joinRoomParams, id);
    }
    ...
    public void sendPublishVideo(String hasAudio,
                                 String hasVideo,
                                 String audioActive,
                                 String videoActive,
                                 String doLoopback,
        ...
        HashMap<String, Object> localsdpOfferParams = new HashMap<>();
        localsdpOfferParams.put("audioActive", audioActive);
        localsdpOfferParams.put("videoActive", videoActive);
        localsdpOfferParams.put("hasAudio", hasAudio);
        localsdpOfferParams.put("hasVideo", hasVideo);
        localsdpOfferParams.put("doLoopback", doLoopback);
        localsdpOfferParams.put("frameRate", frameRate);
        localsdpOfferParams.put("typeOfVideo", typeOfVideo);
        localsdpOfferParams.put("sdpOffer", sdpOffer);
        send("publishVideo", localsdpOfferParams, id);
    }

    public void sendMessage(String method,
                            HashMap<String,Object> message,int id) {
    ...
    public void connectWebSocket(boolean wait) {
        if (isWebSocketConnected()) {
            return;
        }
        super.connectWebSocket();
