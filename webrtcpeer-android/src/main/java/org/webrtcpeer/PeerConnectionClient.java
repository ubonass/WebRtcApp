...
public class PeerConnectionClient {
    ...
    public PeerConnectionClient(Context appContext,
        ...
        this.pcObserver =
                new PeerConnectionObserver(this,
                        executor, peerConnectionParameters,events);
    ...
    private void createPeerConnectionFactoryInternal(
        ...
        preferIsac = peerConnectionParameters.audioCodec != null
                ...
                .equals(MediaConfiguration.AUDIO_CODEC_ISAC);
    ...
    private void createPeerConnectionInternal() {
        ...
        if (dataChannelEnabled) {
            ...
            dataChannel = pcObserver.createDataChannel("ApprtcDemo data",init);
    ...
    public void createOffer() {
        executor.execute(() -> {
            if (peerConnection != null && !isError) {
                ...
                isInitiator = true;
                peerConnection.createOffer(pcObserver, sdpMediaConstraints);
            }
        });
    }
    ...
    public void createAnswer() {
        executor.execute(() -> {
            if (peerConnection != null && !isError) {
                ...
                isInitiator = false;
                peerConnection.createAnswer(pcObserver, sdpMediaConstraints);
            }
        });
    }
    ...
    public void setRemoteDescription(final SessionDescription sdp) {
        executor.execute(() -> {
            ...
            peerConnection.setRemoteDescription(pcObserver, sdpRemote);
        });
    }
