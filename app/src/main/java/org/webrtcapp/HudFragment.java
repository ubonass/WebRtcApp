...
import org.webrtcpeer.MediaConfiguration;
...
public class HudFragment extends Fragment {
    ...
    public void onStart() {
        ...
        if (args != null) {
            videoCallEnabled = args.getBoolean(ExtraInfo.EXTRA_VIDEO_CALL, true);
            displayHud = args.getBoolean(ExtraInfo.EXTRA_DISPLAY_HUD, false);
        }
    ...
    public void updateEncoderStatistics(final StatsReport[] reports) {
        ...
        for (StatsReport report : reports) {
            if (report.type.equals("ssrc") && report.id.contains("ssrc") && report.id.contains("send")) {
                ...
                if (trackId != null && trackId.contains(MediaConfiguration.VIDEO_TRACK_ID)) {
